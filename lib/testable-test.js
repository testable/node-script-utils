...
class TestSteps {
  ...
  constructor() {
    this.cb = {
      startSuite: (suite) => {
        this.reportTestSuiteActions([{ type: 'StartSuite', data: suite }]);
      },
      finishSuite: (suite) => {
        this.reportTestSuiteActions([{ type: 'FinishSuite', data: suite }]);
      },
      startTest: (test) => {
        this.reportTestSuiteActions([{ type: 'StartSuiteTest', data: test }]);
      },
      finishTest: (test) => {
        this.reportTestSuiteActions([{ type: 'FinishSuiteTest', data: test }]);
      }
    };
  ...
  reportTestSuiteActions(suiteActions) {
    this.sendMsg({
      type: suiteActions.type,//"TestSuiteActions",
      data: suiteActions.data,
    });
  }
